...
<template>
  <section aria-labelledby="titre-progression">
    ...
    <div class="grille-joueur">
      <label for="recherche-progression">Rechercher par titre<input id="recherche-progression" v-model="recherche" type="search" placeholder="Titre d’un chapitre ou d’une quête" /></label>
      <label for="statut-quetes">Statut des quêtes<select id="statut-quetes" v-model="statut"><option value="">Tous les statuts visibles</option><option value="active">Actives</option><option value="terminee">Terminées</option><option value="abandonnee">Abandonnées</option></select></label>
    </div>
